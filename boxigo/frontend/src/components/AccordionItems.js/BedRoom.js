  ...
  return (
    <>
      {moveDetails?.items?.rooms
        ?.filter((room) => room.roomName === 'Bed Room')
        ?.map((room) => {
              ...
              <div className="accordion-item-description-wrapper">
                <div className="accordion-item-description">
                  <div className="row">
                    ...
                    <div className="col-lg-3 ml-5">
                      <h3 className="category">Decorative</h3>
                      <div className="row">
                        {room?.categories?.find(category => category.categoryName === 'Decorative')?.itemsList?.all?.map((item, index) => (
                          <React.Fragment key={index}>
                            <div className="col-lg-6">
                              <div className="cat_div">
                                <h6 className="c_name">{item.display_name}</h6>
